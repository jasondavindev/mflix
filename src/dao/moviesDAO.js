...
export default class MoviesDAO {
	 ...
	 */
	static async getMoviesByCountry(countries, expectedKeys) {
		/**
    Ticket: Projection
    ...
    */
		...
		try {
			...
			cursor = await movies.find({ countries: { $in: countries } }, { projection });
		} catch (e) {
    ...
    */
	...
	static async getMovieByID(id) {
      ...
      */
      ...
      const resultMovies = await movies.aggregate(pipeline).next();
      resultMovies['comments'].sort((a, b) => b.date.getTime() - a.date.getTime())
      return resultMovies
		} catch (e) {
			/**
